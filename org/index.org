...
#+date: 2022 Jan 20 12:48
#+options: toc:nil num:nil
#+options: html-link-use-abs-url:nil html-postamble:t
#+options: html-preamble:t html-scripts:t html-style:nil
#+options: html5-fancy:nil tex:t
#+description: Welcome to my site, please excuse the mess
#+keywords:
...
+ 2022.01.18: [[file:blog/20220118.html][Making an RSS Feed for a Static HTML Site]]
